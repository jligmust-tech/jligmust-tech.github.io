...
window.SCAI_DATA = {
  ...
  researchGuide: {
    ...
    citations: [
      ...
      },
      {
        citation: "Weidener, L. et al. (2026). VCBench: A Multi-Dimensional Benchmark for Single-Cell Foundation Models.", status: "Preprint + public release", why: "Capability-stratified benchmark with pre-registered baselines, contamination checks and explicit code traceability", links: [
          ...
          { label: "bioRxiv", url: "https://www.biorxiv.org/content/10.64898/2026.06.18.733146v1.full" },
    ...
    sourceRegistry: [
      ...
      {
        id: "SR-11", name: "LPM", type: "Perturbation representation model", publication: "Nature Computational Science + PubMed", accessed: "2026-09-08", status: "Published paper", artifacts: "Nature article, PubMed record and DOI", role: "Biology-aware perturbation embeddings", note: "The DOI landing page may be crawler-limited; use the linked Nature or PubMed record. Compare as an embedding candidate with matched frozen-probe protocols.", links: [{ label: "Nature", url: "https://www.nature.com/articles/s43588-025-00870-1" }, { label: "PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/41094040/" }, { label: "DOI", url: "https://doi.org/10.1038/s43588-025-00870-1" }]
      },
      {
      ...
      {
        id: "SR-13", name: "VCBench", type: "Virtual-cell benchmark", publication: "Public v1.0.0 repository + bioRxiv preprint", accessed: "2026-09-08", status: "Public benchmark release", artifacts: "Code, capability matrix and contamination manifest", role: "Stage 2 protocol gate", note: "The DOI landing page may be crawler-limited; use the linked bioRxiv record or repository. Match capability rows only; not every dimension is direct response prediction.", links: [{ label: "repository", url: "https://github.com/AppliedScientific/VCBench" }, { label: "bioRxiv", url: "https://www.biorxiv.org/content/10.64898/2026.06.18.733146v1.full" }, { label: "DOI", url: "https://doi.org/10.64898/2026.06.18.733146" }]
      },
      {
    ...
    stage2VirtualCell: [
      {
        priority: "P0", name: "VCBench", year: "2026", kind: "Capability-stratified benchmark", task: "Separate perturbation prediction, representation probes and other single-cell FM capabilities", evidence: "Five models × five dimensions against pre-registered trivial and strongest non-FM baselines; evaluator aligned with Cell-Eval", status: "Public v1.0.0; reproducibility candidate", pros: "Explicit baselines, contamination manifest and manuscript-to-code traceability", cons: "Still a benchmark release rather than independent consensus; some dimensions are not direct response prediction", next: "Pin v1.0.0, record dimension/split definitions, then compare only matched capability rows", links: [{ label: "repository", url: "https://github.com/AppliedScientific/VCBench" }, { label: "bioRxiv", url: "https://www.biorxiv.org/content/10.64898/2026.06.18.733146v1.full" }, { label: "DOI", url: "https://doi.org/10.64898/2026.06.18.733146" }]
      },
      {
